...
public abstract class NisqAnalyzerTestCase {
    ...
    private void createShorImplementations() throws MalformedURLException {
        ...
        shor15qiskit.setOutputParameters(Arrays.asList(new Parameter("phases", DataType.String, "", "")));
        ...
        shor15qiskitPlanQK.setOutputParameters(Arrays.asList(new Parameter("phases", DataType.String, "", "")));
        ...
        shor15pytket.setOutputParameters(Arrays.asList(new Parameter("phases", DataType.String, "", "")));
        ...
        shorGeneralQiskit.setOutputParameters(Arrays.asList(new Parameter("phases", DataType.String, "", "")));
        ...
        shorGeneralPytket.setOutputParameters(Arrays.asList(new Parameter("phases", DataType.String, "", "")));
    ...
    private void createGroverImplementations() throws MalformedURLException {
        ...
        groverFixTruthtable.setInputParameters(
            Arrays.asList(new Parameter("Oracle", DataType.String, "Oracle = '0010000000000000'", "")));
        groverFixTruthtable.setOutputParameters(Arrays.asList(new Parameter("assignment", DataType.String, "", "")));
        ...
        groverGeneralTruthtable.setInputParameters(Arrays.asList(new Parameter("Oracle", DataType.String,
            "Oracle has to be a a binary string of function f in a truth table", "")));
        groverGeneralTruthtable.setOutputParameters(
            Arrays.asList(new Parameter("assignment", DataType.String, "", "")));
        ...
        groverFixSAT.setInputParameters(
            Arrays.asList(new Parameter("Formula", DataType.String, "Formula = (A | B) & (A | ~B) & (~A | B)", "")));
        groverFixSAT.setOutputParameters(Arrays.asList(new Parameter("assignment", DataType.String, "", "")));
        ...
        groverGeneralSAT.setOutputParameters(Arrays.asList(new Parameter("assignment", DataType.String, "", "")));
    ...
    private void assertContainsImplementation(UUID algorithm, String name) {
        Assertions.assertTrue(implementationRepository.findByImplementedAlgorithm(algorithm).stream()
            .anyMatch(impl -> impl.getName().equals(name)));
    }
