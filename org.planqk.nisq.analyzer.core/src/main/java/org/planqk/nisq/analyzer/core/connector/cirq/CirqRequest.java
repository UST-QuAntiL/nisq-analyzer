...
public class CirqRequest {
    ...
    public CirqRequest(URL impl_url, String impl_language, String qpu_name, Map<String, ParameterValue> input_params, String bearerToken) {
    ...
    public CirqRequest(String impl_language, String impl_data, String qpu_name, Map<String, ParameterValue> input_params) {
        this.impl_language = impl_language;
